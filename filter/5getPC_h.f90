	...
	open (14, file='F:\Data\Processed\ncep\sat\PC1_sat_phi_MAM1970-2014.dat',form='binary')
	open (15, file='F:\Data\Processed\ncep\sat\PC1_hf_sat_MAM1970-2014.dat',form='binary')
    ...
    w1=
    w2=
    call hfilter(y1,fx,nm,w1,w2)
    
    do kk=1,nm
        y1_hf(kk)=fx(kk)
    enddo
    do kk=1,nm
	    write(15)y1(kk),y1_hf(kk)
    enddo
...
!CC
        subroutine hfilter(x,fx,nm,w1,w2)
